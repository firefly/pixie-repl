import { Signature, getBytes, hexlify, sha256, toBeArray, verifyMessage, zeroPadValue } from "ethers";
...
export function compute(signer, model, serial, pubkey) {
