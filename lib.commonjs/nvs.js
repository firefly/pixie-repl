...
exports.NVSData = exports.EmptyPage = exports.Page = exports.BlobEntry = exports.BlobIndexEntry = exports.NamespaceEntry = exports.ValueEntry = exports.Entry = exports.Header = void 0;
...
class Header {
    ...
    static fromBinary(data) {
        const state = PageStateMap[(0, data_js_1.fromLeBytes)(data.slice(0, 4))] || "corrupt";
        const seqNo = (0, data_js_1.fromLeBytes)(data.slice(4, 8));
        ...
        (0, errors_js_1.assert)((0, data_js_1.fromLeBytes)(computed) === (0, data_js_1.fromLeBytes)(checksum), `checksum failed`, {
...
class Entry {
    ...
    get binary() {
        ...
        data[3] = this.index;
        // Add the key
        data.set((0, strings_js_1.toUtf8Bytes)(this.key), 8);
        // Add the data
...
class ValueEntry extends Entry {
    ...
    get value() { return (0, data_js_1.fromLeBytes)(this.data); }
}
...
exports.NamespaceEntry = NamespaceEntry;
...
exports.BlobIndexEntry = BlobIndexEntry;
...
class Page {
    ...
    static fromBinary(data) {
        ...
        for (let i = 0; i < 126; i++) {
            ...
            const key = (0, strings_js_1.extractString)(d.slice(8, 24));
            ...
            if (ns === 0) {
                ...
                entry = new ValueEntry(ns, key, (0, data_js_1.fromLeBytes)(value), type);
            }
            else if (type === "blob_data") {
                const length = (0, data_js_1.fromLeBytes)(value.slice(0, 2));
                const blob = [];
                for (let j = 1; j < span; j++) {
                    blob.push(getEntry(++i));
                }
                entry = new BlobEntry(ns, key, (0, data_js_1.concat)(blob).slice(0, length));
...
class NVSData {
    ...
    get binary() {
        ...
        return (0, data_js_1.concat)(pages.map(p => p.binary));
    }
    get csv() {
        ...
        for (const [namespace, kvs] of this.#data) {
            ...
            for (const [key, _value] of kvs) {
                ...
                if (value instanceof Uint8Array) {
                    result.push(`${key}, data, hex, ${(0, data_js_1.hexlify)(value)}`);
                }
                else {
    ...
    get json() {
        ...
        for (const [namespace, kvs] of this.#data) {
            ...
            for (const [key, _value] of kvs) {
                const { value, type } = _value;
                if (value instanceof Uint8Array) {
                    values[key] = { "type": "blob", value: (0, data_js_1.hexlify)(value) };
                }
                else {
                    values[key] = {
                        type: type,
