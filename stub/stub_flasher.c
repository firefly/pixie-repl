...
// 0.1.0
#define STUB_VERSION    (0x00010000)
...
void stub_main()
{
  // Set the CPU to 160Mhz
  // See: https://github.com/espressif/esp-idf/blob/6673376297b921d438790d195014b860eaf8bb17/components/esp_hw_support/port/esp32c3/rtc_clk.c#L166
  {
  ...
  //SLIP_send_debug("init; cpu=%d", esp_rom_get_cpu_ticks_per_us());
